...
export const COMPLAINT_POST_ERROR = "COMPLAINT_POST_ERROR";

export const FETCH_COMPLAINTS_TYPES_REQUEST = "FETCH_COMPLAINTS_TYPES_REQUEST";
export const FETCH_COMPLAINTS_TYPES_SUCCESS = "FETCH_COMPLAINTS_TYPES_SUCCESS";
export const FETCH_COMPLAINTS_TYPES_ERROR = "FETCH_COMPLAINTS_TYPES_ERROR";
//endregion
